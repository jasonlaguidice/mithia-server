-- Blackjack Bank System (Simplified - No Migration Tracking)
USE RTK;
...
ON DUPLICATE KEY UPDATE `npc_identifier`='blackjack_dealer';
...
CREATE TABLE IF NOT EXISTS `blackjack_managers` (
    `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
    `player_name` varchar(50) NOT NULL,
